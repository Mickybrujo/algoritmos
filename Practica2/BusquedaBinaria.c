...
/*
    ...
    metodo de busqueda binaria de forma iterativa.
    */
//Compilación de la libreria: "gcc BusquedaBinaria.c tiempo.c" (Generación del ejecutable)
//*****************************************************************
...
int busquedaBinaria(int arr[], int x, int n)
{
    ...
    while (izquierda <= derecha)
    {
        ...
        // Calcula el valor integral m�s grande que no sea mayor de x.
...
int main(int argc, char *argv[])
{
    ...
    int indice = busquedaBinaria(Arreglo, numero_buscado, n_datos);
